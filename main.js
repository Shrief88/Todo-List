...
const formHandler = ()=>{
    ...
    taskForm.addEventListener('submit',(e)=>{
        ...
        const today = (0,date_fns__WEBPACK_IMPORTED_MODULE_5__["default"])(new Date(todayObject.getFullYear(),todayObject.getMonth(),todayObject.getDate()),'yyyy-MM-dd');
               
        if(newTask.project_id === selectedProject || (selectedProject === "today" && today === dueDate)){
            (0,_taskViewer__WEBPACK_IMPORTED_MODULE_4__.displayTasks)(myProject.tasks);
        }
...
const taskController = (()=>{
    const statusButton = (e)=>{
        ...
        _localStorage__WEBPACK_IMPORTED_MODULE_0__["default"].updateTaskStatus(task.getAttribute("data-project"),task.id)
    }

    const deleteButton = (e)=>{
        const task = e.target.parentElement.parentElement;
        _localStorage__WEBPACK_IMPORTED_MODULE_0__["default"].deleteTask(task.getAttribute("data-project"),task.id);
    ...
    const showEidtForm = (e)=>{
        const taskDiv = e.target.parentElement.parentElement;
        const task = _localStorage__WEBPACK_IMPORTED_MODULE_0__["default"].getTaskById(taskDiv.getAttribute("data-project"),taskDiv.id);
