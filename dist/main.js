...
/* harmony import */ var _taskController__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./taskController */ "./src/modules/taskController.js");
...
function createTask(task){
    ...
    input.addEventListener('click',(e)=>{
        _taskController__WEBPACK_IMPORTED_MODULE_2__["default"].statusButton(e)
    })
    ...
    p.addEventListener('click',(e)=>{
        _taskController__WEBPACK_IMPORTED_MODULE_2__["default"].showInfo(e);
    })
    ...
    editImage.addEventListener('click',(e)=>{
        _taskController__WEBPACK_IMPORTED_MODULE_2__["default"].showEidtForm(e);
    })
    taskInfo2.appendChild(editImage);

    const deleteImage = createimageField("SVGs/trash.svg","Delete" ,"Delete");
    deleteImage.addEventListener('click',(e)=>{
        _taskController__WEBPACK_IMPORTED_MODULE_2__["default"].deleteButton(e);
    })
...
function createProject(projectTitle){
    ...
    container.addEventListener('click',()=>{
        (0,_taskViewer__WEBPACK_IMPORTED_MODULE_0__.sidebarNavigator)(container);
...
function showTaskForm(){
    ...
    let myKeysLength = _localStorage__WEBPACK_IMPORTED_MODULE_1__["default"].getKeysLength();
    for(let i=0; i<myKeysLength;i++){
        (0,_Components__WEBPACK_IMPORTED_MODULE_0__.createOption)(_localStorage__WEBPACK_IMPORTED_MODULE_1__["default"].getProjectByIndex(i));
    }
}   
...
const formHandler = ()=>{
    ...
    taskForm.addEventListener('submit',(e)=>{
        ...
        if(taskForm.classList.contains('edit')){
            _localStorage__WEBPACK_IMPORTED_MODULE_3__["default"].deleteTask(taskForm.getAttribute("data-project"),taskForm.getAttribute('data-id'));
            taskForm.classList.remove('edit');
            taskForm.removeAttribute("data-project");
            taskForm.removeAttribute("data-id");
        }
        ...
        if(selectedProject !== 'today'){
            selectedProjectTasks = _localStorage__WEBPACK_IMPORTED_MODULE_3__["default"].getData(selectedProject);
        }else{
            selectedProjectTasks = _localStorage__WEBPACK_IMPORTED_MODULE_3__["default"].getTodayTasks();
        }
        (0,_taskViewer__WEBPACK_IMPORTED_MODULE_4__.displayTasks)(selectedProjectTasks);
    })
...
const taskController = (()=>{
    ...
    const showEidtForm = (e)=>{
        ...
        (0,_displayController__WEBPACK_IMPORTED_MODULE_0__.showTaskForm)();
...
function displayTasks(tasksList){
    ...
    for (const task of tasksList){
        (0,_Components__WEBPACK_IMPORTED_MODULE_0__.createTask)(task); 
        (0,_Components__WEBPACK_IMPORTED_MODULE_0__.createTaskInfo)(task)
    }
}
...
function init(){
    ...
    inbox.addEventListener('click',()=>{
        (0,_modules_taskViewer__WEBPACK_IMPORTED_MODULE_6__.sidebarNavigator)(inbox);
        (0,_modules_taskViewer__WEBPACK_IMPORTED_MODULE_6__.displayTasks)(_modules_localStorage__WEBPACK_IMPORTED_MODULE_4__["default"].getData('inbox'));
    })
    ...
    todayDiv.addEventListener('click',()=>{
        (0,_modules_taskViewer__WEBPACK_IMPORTED_MODULE_6__.sidebarNavigator)(todayDiv);
    ...
    ;(0,_modules_displayController__WEBPACK_IMPORTED_MODULE_2__.displayController)();
