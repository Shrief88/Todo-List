...
/* harmony export */ });
/* harmony import */ var _formDiv__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./formDiv */ "./src/modules/formDiv.js");
...
const displayController = () => {
  ...
  addTaskButton.addEventListener('click', _formDiv__WEBPACK_IMPORTED_MODULE_0__["default"]);
  const closeFormButton = document.querySelector('#closeForm');
  closeFormButton.addEventListener('click', () => {
    const form = document.querySelector('#overlayForm');
    form.setAttribute('style', 'display:none');
    const taskForm = document.querySelector('#form'); // remove the data that we add when the user click the edit button
  ...
  projectButton.addEventListener('click', () => {
    ...
    projectList.classList.toggle('hide-element'); // make sure than the project form is not showing
...
/* harmony import */ var _projectDiv__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./projectDiv */ "./src/modules/projectDiv.js");
...
const formHandler = () => {
  ...
  taskForm.addEventListener('submit', e => {
    ...
    if (taskForm.classList.contains('edit')) {
      _localStorage__WEBPACK_IMPORTED_MODULE_2__["default"].deleteTask(taskForm.getAttribute('data-project'), taskForm.getAttribute('data-id'));
      taskForm.classList.remove('edit');
      taskForm.removeAttribute('data-project');
      taskForm.removeAttribute('data-id');
    }
    ...
    const myProject = new _project__WEBPACK_IMPORTED_MODULE_1__["default"](project);
    myProject.tasks = _localStorage__WEBPACK_IMPORTED_MODULE_2__["default"].getData(project);
    const newTask = new _task__WEBPACK_IMPORTED_MODULE_0__["default"](title, description, dueDate, priority, project);
    myProject.add_task(newTask);
    _localStorage__WEBPACK_IMPORTED_MODULE_2__["default"].setData(myProject);
    const form = document.querySelector('#overlayForm');
    form.setAttribute('style', 'display:none');
    ...
    if (selectedProject !== 'today') {
      selectedProjectTasks = _localStorage__WEBPACK_IMPORTED_MODULE_2__["default"].getData(selectedProject);
    } else {
      selectedProjectTasks = _localStorage__WEBPACK_IMPORTED_MODULE_2__["default"].getTodayTasks();
    }

    (0,_projectDiv__WEBPACK_IMPORTED_MODULE_3__.displayTasks)(selectedProjectTasks);
  });
  const projectForm = document.querySelector('#project-form');
  projectForm.addEventListener('submit', e => {
    ...
    _localStorage__WEBPACK_IMPORTED_MODULE_2__["default"].setData(newProject);
    document.querySelector('#project-title').value = '';
    (0,_projectDiv__WEBPACK_IMPORTED_MODULE_3__.createProject)(title);
  });
};
...
function showTaskForm() {
  ...
  const form = document.querySelector('#overlayForm');
  form.setAttribute('style', 'display:flex'); // show the list of project in project selection field

  const projectList = document.querySelector('#project');
  projectList.textContent = '';
  const myKeys = _localStorage__WEBPACK_IMPORTED_MODULE_0__["default"].getKeys();
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (showTaskForm);
...
const localStorageHandler = (() => {
  ...
  const getTodayTasks = () => {
    ...
    const today = (0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])(new Date(todayObject.getFullYear(), todayObject.getMonth(), todayObject.getDate()), 'yyyy-MM-dd');
    const myTodayTasks = [];
    const myKeysLength = Object.keys(localStorage).length;
...
/* harmony export */   "sidebarNavigator": () => (/* binding */ sidebarNavigator)
/* harmony export */ });
/* harmony import */ var _localStorage__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./localStorage */ "./src/modules/localStorage.js");
/* harmony import */ var _taskDiv__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./taskDiv */ "./src/modules/taskDiv.js");
...
function displayTasks(tasksList) {
  ...
  for (let i = 0; i < tasksList.length; i++) {
    (0,_taskDiv__WEBPACK_IMPORTED_MODULE_1__.createTask)(tasksList[i]);
    (0,_taskDiv__WEBPACK_IMPORTED_MODULE_1__.createTaskInfo)(tasksList[i]);
  }
}
...
function createProject(projectTitle) {
  ...
  img.addEventListener('click', e => {
    ...
    _localStorage__WEBPACK_IMPORTED_MODULE_0__["default"].deleteProject(key);
    const selectedProject = document.querySelector('.selected').id;

    if (selectedProject === key) {
      displayTasks(_localStorage__WEBPACK_IMPORTED_MODULE_0__["default"].getData('inbox'));
      sidebarNavigator(document.querySelector('#inbox'));
    } else if (selectedProject === 'today') {
      displayTasks(_localStorage__WEBPACK_IMPORTED_MODULE_0__["default"].getTodayTasks());
    } else {
      displayTasks(_localStorage__WEBPACK_IMPORTED_MODULE_0__["default"].getData(selectedProject));
    }
  ...
  container.addEventListener('click', e => {
    if (e.target.alt !== 'delete') {
      ...
      displayTasks(_localStorage__WEBPACK_IMPORTED_MODULE_0__["default"].getData(container.querySelector('p').textContent));
    }
  });
...
/* harmony export */   "createTaskInfo": () => (/* binding */ createTaskInfo)
/* harmony export */ });
/* harmony import */ var _formDiv__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./formDiv */ "./src/modules/formDiv.js");
...
function statusButton(e) {
  ...
  _localStorage__WEBPACK_IMPORTED_MODULE_1__["default"].updateTaskStatus(task.getAttribute('data-project'), task.id);
}

function deleteButton(e) {
  const task = e.target.parentElement.parentElement;
  _localStorage__WEBPACK_IMPORTED_MODULE_1__["default"].deleteTask(task.getAttribute('data-project'), task.id);
...
function showEidtForm(e) {
  const taskDiv = e.target.parentElement.parentElement;
  const task = _localStorage__WEBPACK_IMPORTED_MODULE_1__["default"].getTaskById(taskDiv.getAttribute('data-project'), taskDiv.id);
  (0,_formDiv__WEBPACK_IMPORTED_MODULE_0__["default"])();
...
/* harmony import */ var _modules_projectDiv__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/projectDiv */ "./src/modules/projectDiv.js");
/* harmony import */ var _modules_displayController__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/displayController */ "./src/modules/displayController.js");
...
function init() {
  ...
  if (!_modules_localStorage__WEBPACK_IMPORTED_MODULE_3__["default"].getData('inbox')) {
    const defaultProject = new _modules_project__WEBPACK_IMPORTED_MODULE_1__["default"]('inbox');
    _modules_localStorage__WEBPACK_IMPORTED_MODULE_3__["default"].setData(defaultProject);
  ...
  const day = new Date();
  today.textContent = day.getDate(); // display all tasks in inbox project

  (0,_modules_projectDiv__WEBPACK_IMPORTED_MODULE_4__.displayTasks)(_modules_localStorage__WEBPACK_IMPORTED_MODULE_3__["default"].getData('inbox'));
  const inbox = document.querySelector('.selected');
  inbox.addEventListener('click', () => {
    (0,_modules_projectDiv__WEBPACK_IMPORTED_MODULE_4__.sidebarNavigator)(inbox);
    (0,_modules_projectDiv__WEBPACK_IMPORTED_MODULE_4__.displayTasks)(_modules_localStorage__WEBPACK_IMPORTED_MODULE_3__["default"].getData('inbox'));
  }); // display all project in local storage

  const myKeys = _modules_localStorage__WEBPACK_IMPORTED_MODULE_3__["default"].getKeys();
  ...
  for (let i = 0; i < myKeys.length; i++) {
    ...
    (0,_modules_projectDiv__WEBPACK_IMPORTED_MODULE_4__.createProject)(myKeys[i]);
  } // display todayTasks


  const todayDiv = document.querySelector('#today');
  todayDiv.addEventListener('click', () => {
    (0,_modules_projectDiv__WEBPACK_IMPORTED_MODULE_4__.sidebarNavigator)(todayDiv);
    (0,_modules_projectDiv__WEBPACK_IMPORTED_MODULE_4__.displayTasks)(_modules_localStorage__WEBPACK_IMPORTED_MODULE_3__["default"].getTodayTasks());
  });
  (0,_modules_displayController__WEBPACK_IMPORTED_MODULE_5__["default"])();
